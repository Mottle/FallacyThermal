...
data object QueryHere : GameCommand {
    override val source: String = "fallacy thermal query"
    ...
    override fun execute(context: CommandContext<CommandSourceStack>): Int {
        ...
        val component = Component.literal("Heat at ${player.blockPosition()}: ").withStyle(ChatFormatting.AQUA)
